...
class TimebasedPromodetailpage extends StatefulWidget {
  @override
  _TimebasedPromodetailpageState createState() => _TimebasedPromodetailpageState();
}

class _TimebasedPromodetailpageState extends State<TimebasedPromodetailpage> {
                ...
                columns: [
                  ...
                  DataColumn(
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(width: 40, child: Text('Days', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold))),
                        SizedBox(width: 40, child: Text('Hrs', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold))),
                        SizedBox(width: 40, child: Text('Mins', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold))),
                      ],
                    ),
                    ]
                  ),
